...
VALUES
  (1, 1, '1 рік 4 місяці за очною формою навчання (90 кредитів ЕКТС) / 1 year 4 months of full-time study (90 ECTS credits)');
INSERT INTO official_duration_of_programme (mode_of_study_id, duration_of_study_id, name)
VALUES
  (2, 1, '1 рік 4 місяці заочною формою навчання (90 кредитів ЕКТС) / 1 year 4 months of full-time study (90 ECTS credits)');
-----------------------------------------------------------------------------------------------------
