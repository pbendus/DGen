...
-----------------------------------------------------------------------------------------------------
INSERT INTO student (family_name, given_name, family_name_tr, given_name_tr, date_of_birth, protocol_id, diploma_subject_id, previous_document_id, mode_of_study_id, duration_of_study_id, group_id)
VALUES ('Депутат', 'Андрій Богданович', 'Deputat', 'Andrii', '1997-04-06', 1, 1, 1, 1, 1, 3);
INSERT INTO student (family_name, given_name, family_name_tr, given_name_tr, date_of_birth, protocol_id, diploma_subject_id, previous_document_id, mode_of_study_id, duration_of_study_id, group_id)
VALUES ('Дівнич', 'Ігор Володимирович', 'Divny`ch ', 'Igor', '1995-02-25', 1, 2, 2, 1, 2, 4);
-----------------------------------------------------------------------------------------------------
