INSERT INTO field_of_study (nameUk)
VALUES ('12 - Інформаційні технології / 12 - Information technologies');
-----------------------------------------------------------------------------------------------------
INSERT INTO main_field (nameUk)
...
-----------------------------------------------------------------------------------------------------
INSERT INTO mode_of_study (nameUk)
VALUES ('Очна / Full-time');
INSERT INTO mode_of_study (nameUk)
VALUES ('Заочна / Part-time');
-----------------------------------------------------------------------------------------------------
INSERT INTO official_duration_of_programme (mode_of_study_id, duration_of_study_id, nameUk)
VALUES
...
-----------------------------------------------------------------------------------------------------
INSERT INTO duration_of_training (mode_of_study_id, duration_of_study_id, nameUk)
VALUES
...
------------------------------------------------------------------------------------------------------
INSERT INTO access_requirements (nameUk)
VALUES (
...
------------------------------------------------------------------------------------------------------
INSERT INTO classification_system (nameUk, criteria)
...
-----------------------------------------------------------------------------------------------------
INSERT INTO ects_credits (duration_of_study_id, nameUk)
...
-----------------------------------------------------------------------------------------------------
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('A', 90, 100);
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('B', 82, 89);
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('C', 75, 81);
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('D', 67, 74);
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('E', 60, 66);
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('FX', 35, 59);
INSERT INTO rating_point (nameUk, min_national_score, max_national_score) VALUES ('F', 0, 34);
-----------------------------------------------------------------------------------------------------
INSERT INTO national_grade (nameUk, min_national_score, max_national_score) VALUES ('Відмінно / Excellent', 90, 100);
INSERT INTO national_grade (nameUk, min_national_score, max_national_score) VALUES ('Добре / Good', 75, 89);
INSERT INTO national_grade (nameUk, min_national_score, max_national_score)
VALUES ('Задовільно / Satisfactory', 60, 74);
INSERT INTO national_grade (nameUk, min_national_score, max_national_score) VALUES ('Незадовільно / Fail', 0, 59);
-----------------------------------------------------------------------------------------------------
INSERT INTO educational_component_type (nameUk) VALUES ('Дисципліни / Courses');
INSERT INTO educational_component_type (nameUk) VALUES ('Курсові роботи / Research projects');
INSERT INTO educational_component_type (nameUk) VALUES ('Практика / Internship');
INSERT INTO educational_component_type (nameUk) VALUES ('Державна атестація / State attestation');
-----------------------------------------------------------------------------------------------------
insert into "group" (nameUk) values ('ПІт-16-3');
insert into "group" (nameUk) values ('ПІт-16-4');
insert into "group" (nameUk) values ('ПІ-14-1');
insert into "group" (nameUk) values ('ПІз-14-1');
insert into "group" (nameUk) values ('ПІт-15-2');
